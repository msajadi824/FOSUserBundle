...
class UserManagerTest extends TestCase
{
    ...
    {
        if (!interface_exists('Doctrine\ORM\EntityManager')) {
        ...
        $fieldsUpdater = $this->getMockBuilder('FOS\UserBundle\Util\CanonicalFieldsUpdater')
            ...
            ->getMock();
        $class = $this->getMockBuilder('Doctrine\ORM\Mapping\ClassMetadata')->getMock();
        $this->om = $this->getMockBuilder('Doctrine\ORM\EntityManager')->getMock();
        $this->repository = $this->getMockBuilder('Doctrine\ORM\ObjectRepository')->getMock();
